...
public class playerController : MonoBehaviour
{
    ...
    private AudioSource speker;
    public Sprite invicibility;
    public AudioClip shootsoundeffitc;
    public AudioClip pickupsoundeffict;
    ...
    void Start()
    {
        ...
        speker = GetComponent<AudioSource>();
